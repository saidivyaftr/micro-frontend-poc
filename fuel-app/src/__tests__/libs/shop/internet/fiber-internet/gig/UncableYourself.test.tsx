...
import { UncableYourself } from 'src/libs/shop/internet/fiber-internet/gig'
jest.mock('src/hooks')
...
describe('UncableYourself', () => {
  it('should render correctly', () => {
    ...
    const { queryByTestId } = render(<UncableYourself />)
    expect(queryByTestId('uncable-yourself')).toBeInTheDocument()
  })
})

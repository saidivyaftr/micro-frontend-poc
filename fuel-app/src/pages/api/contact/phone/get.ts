...
export default async function getPhoneNumbers(
  req: NextApiRequest,
  res: NextApiResponse,
) {
  try {
    ...
    const endpoint = `/myfrontier/v2/accounts/${uuid}/phonenumbers`
    ...
    apiErrorLogger(error, 'contact-verification-accountPhones')
    return res

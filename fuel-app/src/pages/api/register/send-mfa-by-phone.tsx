...
const SendMFAByPhone = async (req: NextApiRequest, res: NextApiResponse) => {
  try {
    ...
    const endpoint = `cssauthorization/v1/authorization/mfabysms`
